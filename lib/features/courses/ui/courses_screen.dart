...
import 'package:programmin/features/courses/ui/widgets/course_card.dart';
...
import 'package:programmin/features/courses/ui/widgets/custom_column_no_course.dart';
    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<CourseModel>>(
        ...
        builder: (context, snapshot) {
          ...
          if (courses.isEmpty) {
            return Center(child: CustomColumnNoCourse(isAdmin: isAdmin));
          }
